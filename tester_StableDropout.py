...
import yaml
import pickle
from stddef import Test_Setting_Path, Data_Load_Path
...
class ModelTester:
    def __init__(self, model, dataset, restore_snap=None, num=0):
        self.Num = num
        self.Set = model.make_sess_dict(is_training=False, 1)
    ...
    def test(self, model, dataset):
        ...
        self.test_probs_cnt = np.zeros_like(self.test_probs_ave)

        test_path = join(Test_Setting_Path, 'Pred','Raw{}'.format(self.Num))
